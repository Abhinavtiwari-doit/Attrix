...
export const team: TeamMember[] = [
  ...
  {
    name: "Manjay Verma",
    role: "AI-Powered Application & Web Developer",
    dept: "Engineering",
    location: "Sonipat, Haryana · Remote",
    bio: "Full-stack MERN developer building scalable, AI-powered web and mobile applications. Hackathon winner who has shipped production microservices, a custom component library and a GitHub analytics app — and mentors 100+ students at Sheryians Coding School.",
    experience: [
      "Full-stack Developer — OpenBlockAI (Dec 2025–Present)",
      "Software Engineer Intern — OpenBlockAI (8+ microservices, -25% API latency)",
      "Mentor & Teaching Assistant — Sheryians Coding School (100+ students)",
      "Web Development Intern — Mindstein Software (MERN, Supabase)",
      "Software Engineer Intern — Mind-Stein Technology (15+ REST APIs, MFA/JWT)",
    ],
    tags: ["React.js", "Node.js", "MongoDB", "Next.js", "React Native", "Python", "REST APIs", "GitOps"],
    links: {
      linkedin: "https://www.linkedin.com/in/manjay-verma",
      github: "https://github.com/manjaycoder",
      portfolio: "https://portfolio12-13af.onrender.com/",
    },
  },
  {
    name: "Rakesh Ranjan",
    role: "GTM & AI Automation Engineer",
    dept: "Automation",
    location: "Delhi, India · Remote",
    bio: "Designs go-to-market systems that combine AI automation, CRM and revenue operations. Converts static workflows in Make.com, n8n and Zoho into autonomous AI agents — voice callers, lead scorers and content engines — backed by RAG and vector memory.",
    experience: [
      "Tech Integration & Support Specialist — The Healing Wiz (Apr 2026–Present)",
      "GTM Engineer — Quick Ranks (Feb 2026–Present)",
      "AI Automation Engineer — Quick Ranks (Nov 2025–Feb 2026)",
      "Student Trainee — Code Unnati / SAP (2024–2025)",
      "Published: Privacy-Preserving Data Analytics in Web Applications",
    ],
    tags: ["Make.com", "n8n", "Zoho Flow", "Pabbly Connect", "LLMs & Prompting", "RAG / Pinecone", "FastAPI", "API Integrations"],
    links: {
      linkedin: "https://www.linkedin.com/in/rakeshranjan07",
      portfolio: "https://rakesh-ranjan-automation-9mdhlw1.gamma.site/",
    },
  },
  {
    name: "Prashant Singh",
    ...
    dept: "Design",
    tags: ["Brand Design", "Motion Graphics", "Video Editing", "Adobe Suite"],
  },
  {
    name: "Nitish Pandey",
    role: "Social Media Manager",
    dept: "Marketing",
    tags: ["Content Strategy", "Community", "Paid Social", "Analytics"],
  },
