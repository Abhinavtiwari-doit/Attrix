...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Attrix Technologies — Digital Transformation & Automation" },
      { name: "description", content: "Attrix Technologies helps businesses grow with automation, AI, cloud, CRM, and custom software. Trusted by startups, SMBs, and enterprises." },
